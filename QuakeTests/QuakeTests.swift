...
final class QuakeTests: XCTestCase {
    ...
    func testGeoJSONDecoderDecodesQuake() throws {
        ...
        XCTAssertEqual(quake.detail, URL(string: "https://earthquake.usgs.gov/earthquakes/feed/v1.0/detail/nc73649170.geojson"))
    ...
    func testGeoJSONDecoderDecodesGeoJSON() throws {
        ...
        XCTAssertEqual(decoded.quakes[0].detail,
                       URL(string: "https://earthquake.usgs.gov/earthquakes/feed/v1.0/detail/nc73649170.geojson"))
